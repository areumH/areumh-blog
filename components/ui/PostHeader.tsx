...
export default function PostHeader({ meta }: { meta: Post }) {
  ...
  return (
    <div className="flex flex-col gap-2 items-center">
      <div className="max-w-3xl text-2xl md:text-4xl px-4 font-bold text-center">{title}</div>
      <div className="flex flex-wrap justify-center gap-2 text-xs md:text-sm text-gray-600">
        {tags &&
          tags.map((tag) => (
